...
CREATE TABLE reviews (
 ...
 INSERT INTO reviews (id, restaurant_id, first_name, last_name, reviewer_loc, reviewer_photos, reviewer_friends, reviewer_reviews, review_score, review_date, review_text) 
 VALUES 
 (1, 1, 'Kesha', 'Kar', 'Marina del Rey, CA', 8, 10, 14, 5, '2019-12-07', " love this location. The staff is so nice and I have difficult food requests that they always accommodate. 
 Special nod to Anthony T front host and Apolo  the Manager who turned me on to build your own salads!!! The chipotle vinaigrette is EVERYTHING!!!!!!!!");
